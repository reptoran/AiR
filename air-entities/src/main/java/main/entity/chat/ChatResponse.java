...
public class ChatResponse implements Comparable<ChatResponse>
{
	...
	public List<ChatReq> getReqs()
	{
		return reqs;
	}

	public void setReqs(List<ChatReq> reqs)
	{
		if (reqs == null)
			this.reqs = new ArrayList<ChatReq>();
		else
			this.reqs = reqs;
	}

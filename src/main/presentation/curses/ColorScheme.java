...
public class ColorScheme
{
	...
	{
		return new ColorScheme(Colors.BROWN, Colors.YELLOW, Colors.LIGHT_GREY,
				Colors.DARK_GREY, Colors.WHITE);
	}

	public static ColorScheme specialWoodenScheme()
	{
		return new ColorScheme(Colors.DARK_MAGENTA, Colors.YELLOW, Colors.LIGHT_GREY,
				Colors.DARK_GREY, Colors.WHITE);
	}

	public static ColorScheme monochromeScheme()
	{
		return new ColorScheme(Colors.DARK_GREY, Colors.WHITE, Colors.LIGHT_GREY,
				Colors.DARK_GREY, Colors.WHITE);
	}
